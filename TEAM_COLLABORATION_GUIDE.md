...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **PERSON 1** | **Vishal** | `@vishalvc-lab` | **Customer Self-Ordering Experience (12 Screens)**<br/>Menu, portions, add-ons (Egg/Salna), cart, UPI QR payment, bill breakdown, live order tracking, loyalty & reviews. | `customer-next/components/screens/`<br/>`customer-next/app/page.tsx`<br/>`customer-next/store/useCustomerStore.ts` | `feature/vishal-customer-app` |
