          ...
          <div className="w-[40%] bg-white p-5 overflow-y-auto flex flex-col justify-between font-mono select-none">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <button
                  type="button"
                  onClick={() => setCurrentScreen(6)}
                  className="w-full p-3 bg-purple-50 hover:bg-purple-100 text-purple-950 border border-purple-200 rounded-xl font-black text-xs transition flex items-center justify-between cursor-pointer"
                >
                  <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-[11px] font-bold text-purple-800">Split ➔</span>
                </button>
                ...
                <button
                  type="button"
                  onClick={() => setCurrentScreen(7)}
                  className="w-full p-3 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl font-black text-xs transition flex items-center justify-between cursor-pointer shadow-xs"
                >
                  <div className="flex items-center gap-2.5">
            ...
            <div className="pt-3 border-t border-slate-200">
              <button
                type="button"
                onClick={() => setCurrentScreen(8)}
                className="w-full py-2.5 bg-slate-900 hover:bg-black text-white rounded-xl font-black text-xs transition flex items-center justify-center gap-2 cursor-pointer shadow-xs"
              >
